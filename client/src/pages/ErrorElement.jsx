    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-primary/10 via-white to-teal-50 flex items-center justify-center p-4">
            ...
            <div className="absolute inset-0 -z-10">
                ...
                <div className="absolute top-1/2 left-3/4 w-64 h-64 bg-primary/20 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-pulse delay-500"></div>
            </div>
            ...
            <div className="max-w-2xl mx-auto text-center">
                ...
                <div className="mb-8">
                    <div className="text-9xl font-bold text-primary mb-4 leading-none">
                        404
                    </div>
