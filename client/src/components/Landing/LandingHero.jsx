    ...
    return (
        <section className="relative overflow-hidden">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
                <div className="text-center">
                    ...
                    <motion.a
                        ...
                        className="flex flex-col items-center justify-center mt-4 text-lg font-semibold text-slate-700"
                    >
                        Learn More
                        <motion.div
                            animate={{ y: [0, 5, 0] }}
            ...
            <div className="absolute inset-0 -z-10">
                <div className="absolute top-0 left-1/2 -translate-x-1/2 w-96 h-96 bg-emerald-200 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-pulse"></div>
                ...
                <div className="absolute top-1/2 left-1/4 w-80 h-80 bg-green-200 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-pulse delay-500"></div>
            </div>
        </section>
    );
}
